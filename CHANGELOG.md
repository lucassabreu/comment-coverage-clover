...
- steps from the github workflows updated
...
- temporary revert of the package type to prevent problems
...
- update dependencies for security reasons
  - https://github.com/lucassabreu/comment-coverage-clover/security/dependabot/23
...
[Unreleased]: https://github.com/lucassabreu/comment-coverage-clover/compare/v0.17.0...HEAD
...
[0.15.5]: https://github.com/lucassabreu/comment-coverage-clover/compare/v0.15.4...v0.15.5
